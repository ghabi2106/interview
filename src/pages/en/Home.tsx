              ...
              <div className="mt-3">
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="tv">
                    ...
                    <h6 className="card-title">Intervention level : </h6>
                    <ol>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="requirements-tv">
                          <ul>
                            <li>
                      ...
                      <li>
                        ...
                        <div className="collapse" id="design-development-tv">
                          <ul>
                            <li>
              ...
              <div className="mt-3">
                  ...
                  <div className="card-body text-dark collapse show" id="uaesme">
                    ...
                    <ol>
                      <li>
                        ...
                        <div className="collapse" id="requirements-uaesme">
                          <ul>
                            <li>
                              <strong>Gathering requirements</strong> to
                              understand and document what is required by users
                      ...
                      <li>
                        ...
                        <div className="collapse" id="design-development-uaesme">
                          <ul>
                            <li>
                              <strong>Developing a design </strong>around
                              solutions to the problems presented by
                ...
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="fgic">
                    ...
                    <h6 className="card-title">Benefits</h6>
                    <ul>
                      <li>
                        <p>
                  ...
                  >
                    ...
                    <ol>
                      <li>
                        ...
                        <div className="collapse" id="requirements-carrytrack">
                          <ul>
                            <li>
                              <strong>Gathering requirements</strong> to
                              understand and document what is required by users
              ...
              <div className="mt-3">
                ...
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="ticketing">
                    ...
                    <h6 className="card-title">Best For</h6>
                    <p className="card-text">
