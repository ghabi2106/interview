            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  <div className="collapse" id="mutex">
                    <p>
...
{  
    ...
    mutex.ReleaseMutex();    // Release the Mutex.  
                ...
                <li>
                  ...
                  <div className="collapse" id="lock">
                    <p>
    ...
    {  
      // Your code...  
                ...
                <li>
                  ...
                  <div className="collapse" id="interlocked">
                    <p>
...
static bool UseResource()
{
    Interlocked.Exchange(ref usingResource, 0);
                ...
                <li>
                  ...
                  <div className="collapse" id="semaphore">
                    <p>
...
static void UseResource()
{
    ...
    semaphoreObject.Release();
                ...
                <li>
                  ...
                  <div className="collapse" id="barrier">
                    <p>
    ...
    static void Main(string[] args)
    {
      ...
      tea.Wait();
                ...
                <li>
                  ...
                  <div className="collapse" id="spinlock">
                    <p>
                      ...
                      {`public static void SpinLockDemo()
{
  ...
  Console.WriteLine($"Final balance is {ba.Balance}.");
                ...
                <li>
                  ...
                  <div className="collapse" id="count-down-event">
                    <p>
...
countObject.Wait();`}
                ...
                <li>
                  ...
                  <div className="collapse" id="auto-reset-event">
                    <p>
    ...
    static void UseResource()
    {
        ...
        autoResetEvent.Set();
                ...
                <li>
                  ...
                  <div className="collapse" id="manual-reset-event">
                    <p>
                      Represents a thread synchronization event that, when
    ...
    static void UseResource()
    {
        ...
        manualResetEvent.Reset();
                ...
                <li>
                  ...
                  <div className="collapse" id="spinwait">
                    <p>
        ...
        while (true)
        {
            ...
            spin.SpinOnce();
                ...
                <li>
                  ...
                  <div className="collapse" id="reader-writer-lock">
                    <p>
