          ...
          <article id="stored-procedure">
            ...
            <div>
              ...
              <dl>
                ...
                <dd>
                  <Highlight className="language-sql">{`CREATE PROCEDURE procedure_name
AS
sql_statement
GO;`}</Highlight>
                </dd>
                ...
                <dd>
                  <Highlight className="language-sql">{`EXEC procedure_name;`}</Highlight>
                </dd>
                <dt>Stored Procedure With Multiple Parameters</dt>
                <dd>
                  <Highlight className="language-sql">{`CREATE PROCEDURE SelectAllCustomers @City nvarchar(30), @PostalCode nvarchar(10)
AS
SELECT * FROM Customers WHERE City = @City AND PostalCode = @PostalCode
GO;`}</Highlight>
                </dd>
                <dd>
                  <Highlight className="language-sql">{`EXEC SelectAllCustomers @City = 'London', @PostalCode = 'WA1 1DP';`}</Highlight>
                </dd>
              </dl>
            </div>
          </article>
          <article id="function">
            ...
            <div>
              ...
              <dl>
                <dt>Functions</dt>
                <dd>
                  <Highlight className="language-sql">{`Create function Fun_EmployeeInformation()      
returns table       
as      
return(select * from Employee  ) `}</Highlight>
                </dd>
                <dd>
                  <Highlight className="language-sql">{`create function fun_JoinEmpColumnInfo  
(  
   @EmpContact nchar(15),  
