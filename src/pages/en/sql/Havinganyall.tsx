        ...
        <section id="dotnet-core">
          ...
          <article id="having">
            ...
            <div>
              ...
              <Highlight className="language-sql">{`SELECT column_name(s)
FROM table_name
WHERE condition
          ...
          <article id="all">
            ...
            <div>
              ...
              <dl>
                ...
                <dd>
                  <Highlight className="language-sql">{`SELECT ALL column_name(s)
FROM table_name
WHERE condition;`}</Highlight>
                </dd>
...
(SELECT column_name FROM table_name WHERE condition);`}</Highlight>
          ...
          <article id="order-by">
            ...
            <div>
              ...
              <Highlight className="language-sql">{`SELECT column1, column2, ...
FROM table_name
