          ...
          <article id="http-interceptors">
            ...
            <div>
              ...
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <Highlight className="language-ts">{`import { Injectable } from '@angular/core';
...
export class MyInterceptor implements HttpInterceptor {
  intercept(httpRequest: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    return next.handle(httpRequest);
                ...
                >
                  <Highlight className="language-ts">{`import { NgModule } from '@angular/core';
...
export class HeaderInterceptor implements HttpInterceptor {
  intercept(httpRequest: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    return next.handle(httpRequest.clone({ setHeaders: { API_KEY } }));
                ...
                >
                  <Highlight className="language-ts">{`import { Component, OnInit } from '@angular/core';
