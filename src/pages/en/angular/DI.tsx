      ...
      <div className="bd-cheatsheet container-fluid bg-body">
        <section id="dotnet-core">
          ...
          <article id="di">
            ...
            <div>
              <p>
                Dependencies are services or objects that a class needs to
                perform its function. Dependency injection, or DI, is a design
                pattern in which a class requests dependencies from external
