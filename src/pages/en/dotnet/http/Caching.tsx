        ...
        <section id="dotnet-core">
          ...
          <article id="in-memory-caching">
            ...
            <div>
              ...
              <Highlight className="language-csharp">{`public void ConfigureServices(IServiceCollection services)
{
    services.AddMemoryCache();
    //Rest of the code
}`}</Highlight>
              <Highlight className="language-csharp">{`[Route("api/[controller]")]
[ApiController]
public class EmployeeController : ControllerBase
{
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  ...
                  <br />
                  <Highlight className="language-bash">{`public void ConfigureServices(IServiceCollection services) {
    //Rest of the code
    services.AddStackExchangeRedisCache(options => {
        ...
        options.InstanceName = "localRedis_";
                ...
                <li>
                  ...
                  <br />
                  <Highlight className="language-bash">{`public static class DistributedCacheExtension {
    ...
    public static async Task < T > GetRecordAsync < T > (this IDistributedCache cache, string recordId) {
        ...
        return JsonSerializer.Deserialize < T > (jsonData);
              ...
              <Highlight className="language-bash">{`public class StudentController: ControllerBase {
