          ...
          <article id="views">
            ...
            <div>
              ...
              <dl>
                ...
                <dd>
                  <Highlight className="language-sql">{`CREATE VIEW view_name AS
...
WHERE condition;`}</Highlight>
                ...
                <dd>
                  <Highlight className="language-sql">{`CREATE OR REPLACE VIEW view_name AS
SELECT column1, column2, ...
FROM table_name
WHERE condition;`}</Highlight>
                </dd>
                ...
                <dd>
                  <Highlight className="language-sql">{`DROP VIEW view_name;`}</Highlight>
                </dd>
              </dl>
            </div>
          </article>
