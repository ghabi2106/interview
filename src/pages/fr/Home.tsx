            ...
            <div>
              ...
              <div className="mt-3">
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="tv">
                    ...
                    <h6 className="card-title">Fonctionnalités</h6>
                    <ul>
                    ...
                    <h6 className="card-title">Niveau d'intervention :</h6>
                    <ol>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="conception-détaillée-tv">
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-tv">
                          <p>
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-tv"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-tv">
                          <p>
                      ...
                      <li>
                        ...
                        <div className="collapse" id="amélioration-continue-tv">
                          <p>
                    ...
                    <h6 className="card-title">Outils</h6>
                    <p className="card-text">
                      .Net Core 3.1, .Net Standard 4.6, Angular 10, dapper, EF
                    </p>
                    <h6 className="card-title">Methodologies</h6>
                    <p className="card-text">
            ...
            <div>
              ...
              <div className="mt-3">
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="uaesme">
                    <h6 className="card-title">Description</h6>
                    <p>
                    ...
                    <ol>
                      <li>
                        ...
                        <div className="collapse" id="definition-objectifs-uaesme">
                      ...
                      <li>
                        ...
                        <div className="collapse" id="recherche-solutions-uaesme">
                      ...
                      <li>
                        ...
                        <div className="collapse" id="conception-détaillée-uaesme">
                          La conception détaillée est la phase de développement
                          du projet. C’est ici que l’on construit le projet dans
                          son intégralité et dans le respect des cahiers des
                          charges.
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-uaesme">
                          <p>
                            La phase de test intervient ensuite pour{" "}
                            <strong>
                              identifier les bugs potentiels et vérifier le bon
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-uaesme"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-uaesme">
                          <p>
                            La phase de suivi consiste à{" "}
                            <strong>
                              mesurer périodiquement l’efficacité du projet
                      ...
                      <li>
                        ...
                        <div className="collapse" id="amélioration-continue-uaesme">
                          <p>
                            L’amélioration continue consiste à mettre en place
                            des actions correctives en regard des{" "}
                            <strong>retombées mesurées</strong> dans la phase de
                ...
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="fgic">
                    <h6 className="card-title">Description</h6>
                    <p className="card-text">
                    ...
                    <ol>
                      <li>
                        ...
                        <div className="collapse" id="definition-objectifs-fgic">
                          Il vous faudra répondre à la question “Pourquoi ?”.
                        </div>
                      </li>
                      <li>
                        ...
                        <div className="collapse" id="recherche-solutions-fgic">
                          Une fois vos objectifs définis, vous devez rechercher
                          des solutions permettant d’y répondre. Vous devez donc
                          lister l’ensemble des solutions possibles et les
                          classer en fonction de vos critères de choix (les plus
                      ...
                      <li>
                        ...
                        <div className="collapse" id="conception-preliminaire-fgic">
                          la conception préliminaire est la première étape de la
                          conception pure, c’est ici que vous allez réaliser
                          dans les grandes lignes la maquette visuelle (web
                          design) de votre projet. Dans cette étape les
                      ...
                      <li>
                        ...
                        <div className="collapse" id="conception-détaillée-fgic">
                          La conception détaillée est la phase de développement
                          du projet. C’est ici que l’on construit le projet dans
                          son intégralité et dans le respect des cahiers des
                          charges.
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-fgic">
                          <p>
                            La phase de test intervient ensuite pour{" "}
                            <strong>
                              identifier les bugs potentiels et vérifier le bon
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-fgic"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-fgic">
                          <p>
                            La phase de suivi consiste à{" "}
                            <strong>
                              mesurer périodiquement l’efficacité du projet
                      ...
                      <li>
                        ...
                        <div className="collapse" id="amélioration-continue-fgic">
                          <p>
                            L’amélioration continue consiste à mettre en place
                            des actions correctives en regard des{" "}
                            <strong>retombées mesurées</strong> dans la phase de
            ...
            <div>
              ...
              <div className="mt-3">
                <div className="card border-warning mb-3">
                  ...
                  <div
                    className="card-body text-dark collapse show"
                    id="carrytrack"
                  >
                    <h6 className="card-title">Description :</h6>
                    <p>
                    ...
                    <h6 className="card-title">Avantages :</h6>
                    <p>
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-carrytrack">
                          <p>
                            La phase de test intervient ensuite pour{" "}
                            <strong>
                              identifier les bugs potentiels et vérifier le bon
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-carrytrack"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-carrytrack">
                          <p>
                            La phase de suivi consiste à{" "}
                            <strong>
                              mesurer périodiquement l’efficacité du projet
            ...
            <div>
              ...
              <div className="mt-3">
                  ...
                  >
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-addinvoice">
                          <p>
                            La phase de test intervient ensuite pour{" "}
                            <strong>
                              identifier les bugs potentiels et vérifier le bon
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-addinvoice"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-addinvoice">
                          <p>
                            La phase de suivi consiste à{" "}
                            <strong>
                              mesurer périodiquement l’efficacité du projet
                ...
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="dmi">
                    <h6 className="card-title">Description</h6>
                    <p className="card-text">
                    ...
                    <ol>
                      <li>
                        ...
                        <div className="collapse" id="definition-objectifs-dmi">
                          Il vous faudra répondre à la question “Pourquoi ?”.
                        </div>
                      </li>
                      <li>
                        ...
                        <div className="collapse" id="recherche-solutions-dmi">
                          Une fois vos objectifs définis, vous devez rechercher
                          des solutions permettant d’y répondre. Vous devez donc
                          lister l’ensemble des solutions possibles et les
                          classer en fonction de vos critères de choix (les plus
                      ...
                      <li>
                        ...
                        <div className="collapse" id="cahier-charges-technique-dmi">
                          Le cahier des charges techniques est l’étape qui va
                          définir les solutions technologiques à utiliser pour
                          répondre au cahier des charges fonctionnelles. Le
                          cahier des charges techniques statuera sur les
                      ...
                      <li>
                        ...
                        <div className="collapse" id="conception-preliminaire-dmi">
                          la conception préliminaire est la première étape de la
                          conception pure, c’est ici que vous allez réaliser
                          dans les grandes lignes la maquette visuelle (web
                          design) de votre projet. Dans cette étape les
                      ...
                      <li>
                        ...
                        <div className="collapse" id="conception-détaillée-dmi">
                          La conception détaillée est la phase de développement
                          du projet. C’est ici que l’on construit le projet dans
                          son intégralité et dans le respect des cahiers des
                          charges.
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-dmi">
                          <p>
                            La phase de test intervient ensuite pour{" "}
                            <strong>
                              identifier les bugs potentiels et vérifier le bon
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-dmi"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-dmi">
                          <p>
                            La phase de suivi consiste à{" "}
                            <strong>
                              mesurer périodiquement l’efficacité du projet
                      ...
                      <li>
                        ...
                        <div className="collapse" id="amélioration-continue-dmi">
                          <p>
                            L’amélioration continue consiste à mettre en place
                            des actions correctives en regard des{" "}
                            <strong>retombées mesurées</strong> dans la phase de
                ...
                <div className="card border-warning mb-3">
                  ...
                  <div className="card-body text-dark collapse show" id="ticketing">
                    <h6 className="card-title">Description</h6>
                    <p className="card-text">
                    ...
                    <h6 className="card-title">Qui utilise TravelWorks ?</h6>
                    <p>
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        <div className="collapse" id="tests-recettes-ticketing">
                          <p>
                            La phase de test intervient ensuite pour{" "}
                            <strong>
                              identifier les bugs potentiels et vérifier le bon
                      ...
                      <li>
                        ...
                        <div className="collapse" id="déploiement-ticketing"></div>
                      </li>
                      <li>
                        <a
                          data-bs-toggle="collapse"
                        ...
                        <div className="collapse" id="suivi-pilotage-ticketing">
                          <p>
                            La phase de suivi consiste à{" "}
                            <strong>
                              mesurer périodiquement l’efficacité du projet
