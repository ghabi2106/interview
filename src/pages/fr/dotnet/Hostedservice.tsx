        ...
        <section id="dotnet-core">
          ...
          <article id="ihostedservice">
            ...
            <div>
              ...
              <Highlight className="language-csharp">{`public class IHostedService1 : IHostedService
    {
    ...
    services.AddHostedService<IHostedService1>();
          ...
          <article id="backgroundservice">
            ...
            <div>
              ...
              <Highlight className="language-csharp">{`protected override async Task ExecuteAsync(CancellationToken stoppingToken)
{
