    ...
    <>
      ...
      <div className="bd-cheatsheet container-fluid bg-body">
        <section id="dotnet-core">
          ...
          <article id="variable">
            <h6>Variable</h6>
            <Highlight className="language-scss">{`$variablename: value;`}</Highlight>
          </article>
          <article id="data-types">
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  <b>String</b>
                  <Highlight className="language-scss">{`$default-font: 'Lucida';`}</Highlight>
                </li>
                <li>
                  <b>List</b>: Une liste SassScript est une série de valeurs
                  séparées par des espaces ou des virgules.
                  <Highlight className="language-scss">
  ...
  <statements> 
          ...
          <article id="import">
            ...
            <div>
              ...
              <Highlight className="language-scss">{`@import filename;`}</Highlight>
              <Highlight className="language-scss">
